...
| `src/app-route.mjs` | More static extensions (`md`, `whl`, `tar`); `/demo/` (shell, Pyodide, wheels, host) and `/api/anthropic/` (proxy) are never routed to PHP; public-base helpers for sub-path hosting (GitHub project Pages). |
